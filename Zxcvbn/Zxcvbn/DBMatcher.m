...
- (NSArray *)loadFrequencyLists
{
    ...
    NSString *filePath = [[NSBundle bundleForClass:[DBMatchResources class]] pathForResource:@"frequency_lists" ofType:@"json"];
...
{
    NSString *filePath = [[NSBundle bundleForClass:[DBMatchResources class]] pathForResource:@"adjacency_graphs" ofType:@"json"];
    NSData *data = [NSData dataWithContentsOfFile:filePath];
